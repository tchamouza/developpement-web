            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition duration-300 group">
                    <div class="relative overflow-hidden">
                        <img src="https://images.pexels.com/photos/2034335/pexels-photo-2034335.jpeg" alt="{{ $destination->nom }}" class="w-full h-48 object-cover group-hover:scale-110 transition duration-300">
