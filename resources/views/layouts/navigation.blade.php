    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @auth
                        ...
                        <x-nav-link :href="route('reservations.create')" :active="request()->routeIs('reservations.*')">
                            {{ __('Réserver') }}
                        </x-nav-link>
                    @endauth
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                @else
                    <div class="space-x-4">
                        <a href="{{ route('login') }}" class="text-white hover:text-gray-300 px-3 py-2 rounded-md text-sm font-medium">Connexion</a>
                        <a href="{{ route('register') }}" class="bg-yellow-500 hover:bg-yellow-600 text-black px-3 py-2 rounded-md text-sm font-medium">Inscription</a>
                    </div>
                @endauth
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                ...
                <x-responsive-nav-link :href="route('reservations.create')" :active="request()->routeIs('reservations.*')">
                    {{ __('Réserver') }}
                </x-responsive-nav-link>
            @endauth
