        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition duration-300">
                    <div class="mb-4">
                        <p class="text-gray-600 italic">
                            "Nous avons réservé un séjour en Grèce avec cette agence et avons été agréablement surpris par les 
                            prestations pour le prix. Les hôtels étaient bien situés, les transferts fluides, et l'équipe toujours 
                ...
                <div class="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition duration-300">
                    <div class="mb-4">
                        <p class="text-gray-600 italic">
                            "Notre road-trip en Californie avec les enfants était tout simplement magique. L'agence a pensé à tout : 
                            des activités adaptées aux petits, des hébergements familiaux et même des bons plans restaurants. Un 
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <div class="text-2xl mr-3">👤</div>
                            <div>
                                <p class="font-semibold">La famille Dupont</p>
                            </div>
                        </div>
                        <div class="flex text-yellow-500">
                            ⭐⭐⭐⭐⭐
                ...
                <div class="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition duration-300">
                    <div class="mb-4">
                        <p class="text-gray-600 italic">
                            "En tant que voyageur solo, je voulais un circuit sécurisé et enrichissant en Amérique du Sud. L'agence 
                            m'a guidé vers des destinations parfaites et m'a donné des astuces pour bien profiter. Tout s'est 
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <div class="text-2xl mr-3">👤</div>
                            <div>
                                <p class="font-semibold">Nicolas</p>
                            </div>
                        </div>
                        <div class="flex text-yellow-500">
                            ⭐⭐⭐⭐⭐
